...
-- CreateEnum
CREATE TYPE "EthnicityEnum" AS ENUM ('AsianAmerican', 'Black', 'White', 'Hispanic', 'SouthAsian', 'MiddleEastern', 'SouthEastAsian', 'Pacific');

-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Brown', 'Blue', 'Green', 'Gray', 'Hazel');
