...
//     return (
//       <div className="rounded-xl border-2 max-w-[400px] p-2 cursor-pointer">
//         <div className="flex p-4 gap-4">
//           <img src={props.imageUrl} className="rounded w-full h-auto object-cover" />
//         </div>
//       </div>
//     );
//   }
...
export function ImageCard(props : TImage) 
 {
    ...
    <div className="flex p-4 gap-4">
   {/* {props.status === "Generated" ? <img src={props.imageUrl}  className="rounded"/> : <Skeleton className=" w-full rounded h-40 "/>} */}
   {props.status === "Generated" && props.imageUrl.trim() !== "" ? (
  <img src={props.imageUrl} className="rounded w-full h-auto object-cover" />
) : (
  <Skeleton className="w-full rounded h-40" />
)}
   </div>
